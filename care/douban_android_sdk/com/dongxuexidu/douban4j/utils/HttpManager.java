...
public class HttpManager {
  ...
  private boolean hasAccessTokenBeenSet() {
    return !(this.accessToken == null || TextUtils.isEmpty(this.accessToken));
  }
  
  public String getResponseString(String url, List<NameValuePair> params,  boolean needAccessToken) throws DoubanException, IOException {
